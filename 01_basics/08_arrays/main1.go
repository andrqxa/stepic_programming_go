...
var currChangIdx int
var chngIndx [6]int
for i := 0; i < 6; i++ {
	fmt.Scan(&currChangIdx)
	chngIndx[i] = currChangIdx
}
for i := 0; i < 6; i++ {
	workArray[chngIndx[i]], workArray[chngIndx[i+1]] = workArray[chngIndx[i+1]], workArray[chngIndx[i]]
	i++
}
for i := 0; i < 10; i++ {
